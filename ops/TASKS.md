...
- [x] 包 README 通过上游 Model Experience 与 limitations 门禁
- [x] 非 trivial 改动补 Agent Note
...
- [x] 场景 A：只读排查"web-01 的 nginx 502"，全程无写入
- [x] 场景 B：审批后重启后端并复验
- [x] 升级门禁演练：兼容升级插件保留、peer 不匹配时停用并报错
